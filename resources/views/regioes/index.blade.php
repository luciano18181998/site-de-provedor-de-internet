...
<body>
    ...
    <div class="main-content">
        ...
        <a href="{{ route('regioes.create') }}" class="btn-add">Adicionar Região</a>
            ...
            <tbody>
                @foreach($regioes as $regiao)
                    <tr>
                        <td>{{ $regiao->nome }}</td>
                        <td>
                            <form action="{{ route('regioes.destroy', $regiao->id) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir esta região?');">
                                @csrf
                                @method('DELETE')
